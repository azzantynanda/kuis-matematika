package com.example.azanty.kuiscerda;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        jwb=(TextView)findViewById(R.id.text4);
        jb=(TextView)findViewById(R.id.text5);
        js=(TextView)findViewById(R.id.text6);
    ...
    public void cek(View view) {
        ...
        if(c==hasil){
            jwb.setText("Jawaban anda benar");
            bnr++;
            jb.setText(Integer.toString(bnr));
        }else {
            jwb.setText("Jawaban anda salah");
            slh++;
            js.setText(Integer.toString(slh));
        }

        SharedPreferences sh=getSharedPreferences("MyOwnShared",MODE_PRIVATE);
        SharedPreferences.Editor myshedt=sh.edit();
        myshedt.putString("jawabanbenar",jb.getText().toString());
        myshedt.putString("jawabansalah",js.getText().toString());
        myshedt.commit();
    }
    ...
    protected void onResume() {
        ...
        String b1=shd.getString("jawabanbenar","");
        String s1=shd.getString("jawabansalah",""); //mendapatkan nilai yang telah disave
        jb.setText(b1);
        js.setText(s1);
    }
}
